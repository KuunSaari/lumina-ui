...
describe('Button.vue', () => {
  ...
  test('basic button', async () => {
    ...
    // class
    expect(wrapper.classes()).toContain(bem.m('primary'))
  ...
  test('disabled button', async () => {
    ...
    // class
    expect(wrapper.classes()).toContain(bem.is('disabled'))
  ...
  it('should has the correct type class when type prop is set', () => {
    const types = ['primary', 'success', 'warning', 'default', 'danger']
    types.forEach((type) => {
      const wrapper = mount(Button, {
        props: {
      ...
      expect(wrapper.classes()).toContain(bem.m(type))
    })
  })
  ...
  it('should has the correct size class when size prop is set', () => {
    ...
    sizes.forEach((size) => {
      ...
      expect(wrapper.classes()).toContain(bem.m(size))
    })
  })
  ...
  it.each([
    ...
    (prop: string, _: any) => {
      ...
      expect(wrapper.classes()).toContain(bem.is(prop, true))
    },
  )
  ...
  it('should display loading icon and not emit click event when button is loading', async () => {
    ...
    const iconElement = wrapper.findComponent(Icon)
    expect(wrapper.find(`.${bem.e('loading-icon')}`).exists()).toBe(true)
    expect(iconElement.exists()).toBeTruthy()
...
describe('ButtonGroup.vue', () => {
  test('basic button group', async () => {
    ...
    expect(wrapper.classes()).toContain(bem.concatBlock('group'))
  })
  ...
  test('button group size', () => {
    ...
    sizes.forEach((size) => {
      ...
      expect(buttonWrapper.classes()).toContain(bem.m(size))
    })
  })
  ...
  test('button group type', () => {
    ...
    types.forEach((type) => {
      ...
      const buttonWrapper = wrapper.findComponent(Button)
      expect(buttonWrapper.classes()).toContain(bem.m(type))
    })
  })
  ...
  test('button group disabled', () => {
    ...
    const buttonWrapper = wrapper.findComponent(Button)
    expect(buttonWrapper.classes()).toContain(bem.is('disabled'))
  })
})
